...
#define FFMPEG_CONFIGURATION " --enable-pthreads --enable-mp3lame --enable-shared --enable-vorbis --enable-amr_nb --enable-amr_nb-fixed --enable-amr_wb --enable-amr_if2 --enable-libogg "
#define ARCH_X86 1
